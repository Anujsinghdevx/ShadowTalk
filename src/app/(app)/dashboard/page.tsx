...
import {WhatsappShareButton, WhatsappIcon, TelegramShareButton,TelegramIcon,LinkedinShareButton,LinkedinIcon} from 'react-share';
  ...
  const fetchMessages = useCallback(
    async (refresh: boolean = false) => {
      ...
      try {
        ...
        // Check if messages exist, if not, just set an empty array without throwing an error
        ...
        // Only show an error toast if the response contains an actual error message
